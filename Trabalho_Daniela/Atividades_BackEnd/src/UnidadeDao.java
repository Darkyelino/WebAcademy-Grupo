...
public class UnidadeDao implements IDao<Unidade> { //[INDIVIDUAL] Criar a classe UnidadeDao, de forma semelhante à classe
  //EspecialideDao. Criar os métodos insert(), update() e delete() para a classe ProfissionalDao. (Entrega: 28/05/2024)
